...
| The game itself (canonical build, V2) | [swordforgeV2.html](swordforgeV2.html) |
...
- **(pre-2026-08-10)** — [specs/game-design.md](specs/game-design.md) — mechanics SSOT, kept in sync with the code. `canon` — supersedes the archive GDD. Note: written against V1; V2 delta pending.
